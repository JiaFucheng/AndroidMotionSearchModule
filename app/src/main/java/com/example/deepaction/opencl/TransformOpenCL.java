...
public class TransformOpenCL extends Transform {

    private final static String TAG = "TransformOpenCL";

    public TransformOpenCL(int width, int height, int representation, String bnParamFilePath) {
